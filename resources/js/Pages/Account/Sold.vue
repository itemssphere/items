    ...
    <Authenticated>
        ...
        <div class="d-flex justify-content-between flex-column flex-lg-row">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="organization__content--title d-flex align-items-center organization__content--padding bold">
                    Sold
                </h1>
                <div class="cart-diagram d-flex d-lg-none align-items-end regular">
                    <div class="cart-diagram__list d-flex align-items-end">
                        <div class="cart-diagram__list--item" style="height: 20%"></div>
                        <div class="cart-diagram__list--item" style="height: 30%"></div>
                        <div class="cart-diagram__list--item" style="height: 40%"></div>
                    </div>
                </div>
            </div>
            <form action="" class="cart-head d-block d-lg-flex align-items-lg-center organization__content--padding">
                <div class="d-flex">
                    <p class="cart-head__title regular">Filtr from</p>
                    <div class="cart-statistic d-flex d-lg-none align-items-center regular">
                        <p>
                        ...
                        <p class="d-none d-lg-block bold">
                            Your earn ₾3,678.78
                        </p>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <button class="d-none d-lg-block cart-item__cancel cart-head--btn bold">cancel</button>
                </div>
        ...
        <div class="d-flex justify-content-between">
            <div class="cart-file d-flex align-items-end">
                <button class="cart-file__btn bold cart-file--blue d-none d-lg-block">
                    export
                </button>
                <div class="cart-diagram d-none d-lg-flex align-items-end regular">
                    Last 6 month sold
                    <div class="cart-diagram__list d-flex align-items-end">
                        <div class="cart-diagram__list--item" style="height: 20%"></div>
                        <div class="cart-diagram__list--item" style="height: 60%"></div>
                        <div class="cart-diagram__list--item" style="height: 20%"></div>
                        <div class="cart-diagram__list--item" style="height: 100%"></div>
                        <div class="cart-diagram__list--item" style="height: 20%"></div>
                        <div class="cart-diagram__list--item" style="height: 50%"></div>
                    </div>
                </div>
            </div>
            <div class="d-none cart-statistic d-lg-flex align-items-center regular">
                <p>
                    <img src="/assets/img/svg/eye-cart.svg" alt="">
                    Products View 124
                </p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <form class="d-flex d-lg-block justify-content-between">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-4 d-flex flex-column">
                            <div class="d-flex flex-wrap flex-lg-column justify-content-between align-items-lg-end">
                                <div class="shop-detail__info--color">
                ...
                <div class="col-12">
                    <div class="cart-order">
                        ...
                        <div class="cart-order__body d-flex justify-content-lg-between align-items-lg-center flex-column flex-lg-row">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="cart-order__body--desc regular">bought from you 3 times</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
