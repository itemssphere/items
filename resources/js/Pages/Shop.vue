...
import PickerCategories from "@/Components/Navigation/Pickers/PickerCategories.vue"
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-lg-4">
                    <div class="product-filter__item d-flex align-items-center justify-content-end justify-content-lg-center">
                      ...
                      <div class="select">
                        <select class="select__list regular">
                          <option value="" class="select__list--item">Delivery</option>
                          <option value="" class="select__list--item">Asc</option>
                          <option value="" class="select__list--item">Desc</option>
                        </select>
                      </div>
                    </div>
                  </div>
              ...
              <div class="social-program-slider__item shop__item">
                ...
                <div class="social-program-slider__item--text">
                  <a href="" class="title-link">
                    <h1 class="social-program-slider__item--title bold">
